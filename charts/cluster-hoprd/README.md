...
| `clusterHoprd.dnsName`                          | DNS name for the cluster of nodes                                                        | `""`                                                |
...
| `clusterHoprd.nodes.deployment.annotations`     | Annotations to be added to Hoprd nodes deployment                                        | `{}`                                                |
| `clusterHoprd.nodes.deployment.env`             | Environment variables to be added to Hoprd nodes deployment                              | `""`                                                |
| `clusterHoprd.nodes.deployment.extraContainers` | Extra containers to be added to Hoprd nodes deployment                                   | `""`                                                |
| `clusterHoprd.nodes.deployment.labels`          | Labels to be added to Hoprd nodes deployment                                             | `{}`                                                |
| `clusterHoprd.nodes.deployment.livenessProbe`   | Liveness probe to be added to Hoprd nodes deployment                                     | `""`                                                |
| `clusterHoprd.nodes.deployment.readinessProbe`  | Readiness probe to be added to Hoprd nodes deployment                                    | `""`                                                |
| `clusterHoprd.nodes.deployment.resources`       | Resources to be added to Hoprd nodes deployment                                          | `""`                                                |
| `clusterHoprd.nodes.deployment.startupProbe`    | Startup probe to be added to Hoprd nodes deployment                                      | `""`                                                |
